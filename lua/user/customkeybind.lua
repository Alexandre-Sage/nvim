...
-- map({ "v", "n", "i" }, "", "[", { desc = "Replace [ by ù in all mode (azerty mapping)" })
-- map({ "v", "n", "i" }, "*", "]", { desc = "Replace [ by ù in all mode (azerty mapping)" })
-- map({ "v" }, "aù", "a[", { desc = "Replace a[ in visual mode (azerty mappin)" })
-- map({ "v" }, "a*", "a]", { desc = "Replace a] in visual mode (azerty mappin)" })
-- map({ "v" }, "iù", "i[", { desc = "Replace i[ in visual mode (azerty mappin)" })
-- map({ "v" }, "i*", "i]", { desc = "Replace i] in visual mode (azerty mappin)" })
-- map_key({ "v", "n" }, "j", "<Up>", { desc = "" })
-- map_key({ "v", "n" }, "k", "<Down>", { desc = "" })
-- map_key({ "v", "n" }, "l", "<Left>", { desc = "" })
-- map_key({ "v", "n" }, "m", "<Right>", { desc = "" })
